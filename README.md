...
# Changes made to allow `surechembl-data-client` compatibility with PostgreSQL and better life quality
...
* Added `src/update_daily_frontfiles.sh`. Load frontfiles for yesterday (schedule with crontab).
